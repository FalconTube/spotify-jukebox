// Taken from: https://github.com/yongxin-tech/Flutter_Dio_Mock_Interceptor
...
class MockInterceptor extends Interceptor {
  ...
  void onRequest(
    ...
    if (route == null) {
      // Extract first route from large API call
      ...
      if (match != null) {
        // Check if a smaller version of the complete API call exists
        // in the mock json
        final potentialRoute = _routes[match];
    ...
    final Map<String, dynamic> jsonData = json.decode(resData);
